...
def get_params():
    params = {
        'weight': '/data/wangzerui/paper2_result/exp41/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg yolov8
        # 'weight': '/data/wangzerui/paper2_result/exp41/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg  my
        'device': 'cuda:0',
        # 'method': 'HiResCAM', # LayerCAM
        ...
        'conf_threshold': 0.2, # 0.2 # 越小 热力图的位置就越多
        'ratio': 0.02, # 0.02-0.1
        'show_box': False, # False
        'renormalize': False
    }
    return params
...
if __name__ == '__main__':
    ...
    model(r'/data/wangzerui/NWPU VHR-10 dataset/test/images/', '/data/wangzerui/vis_paper2/N10-my-heatmap/')  # 第一个是检测的文件, 第二个是保存的路径
    # /data/wangzerui/vis_paper2/N10-my-heatmap/
